...
const CustomKeyboardJoinPage = ({
  setValue,
  namesOnly,
  handleSubmit,
}: KeyboardProps): React.ReactElement => {
  const [numpad, setNumpad] = useState<boolean>(true)
  ...
  return (
    ...
    >
      <Keyboard
        ...
        layout={{
          default: getKeyboardLayout(false, numpad, caps),
        }}
...
export default CustomKeyboardJoinPage
